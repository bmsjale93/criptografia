...
# Crear un objeto ChaCha20-Poly1305 cipher
cifrado = ChaCha20_Poly1305.new(key=clave, nonce=nonce)

# Cifrar el texto en claro
textoCifrado, tag = cifrado.encrypt_and_digest(texto.encode())

#Personalizamos la impresión por consola
ancho = 50
num_guiones1 = 20
num_guiones2 = 54
textoTitulo = "-" * num_guiones1 + " EJERCICIO 3B " + "-" * num_guiones1
...
print("El tag de autenticación es:", base64.b64encode(tag).decode())
print()